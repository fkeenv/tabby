...
- Pro-rata Adjustments use already-rounded Line Item subtotals as weights. This perturbs a ratio by a sub-unit and does not compound, because each Adjustment is still exactly allocated regardless of its weights.
